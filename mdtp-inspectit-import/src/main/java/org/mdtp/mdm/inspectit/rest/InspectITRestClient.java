...
public class InspectITRestClient {
	...
	private static final String ALL_AGENTS_PATH = "/rest/data/platform/all";
	
	private static final String ALL_METHODS_PATH = "/rest/data/platform/methods";
	...
	public Iterable<MethodIdent> fetchAllMethods(long platformId) throws IOException {
		...
		MethodIdent[] result = rest.performGet(ALL_METHODS_PATH, MethodIdent[].class, params);
